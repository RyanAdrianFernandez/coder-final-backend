...
export const sent_sms = async (req, res) => {
  try {
    const result = await client.messages.create({
      body: "REGISTRO EXITOSO. Tu usuario registrado es: ryanfer818@gmail.com",
...
export const sent_contacto_nave = async (req, res) => {
  try {
    ...
    const result = await transport.sendMail({
      from: email,
      to: "proyectoGuitars@gmail.com",
      subject: "Proyecto Guitars - Mensaje de contacto",
      html: `
      <div>
